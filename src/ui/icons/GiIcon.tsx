...
interface GiIconProps extends IconComponentProps {}

const GiIcon: React.FC<GiIconProps> = (props: GiIconProps) => {
  const {
    fill = "none",
    size = 20,
    iconClassName = "",
...
const MemoGiIcon = React.memo(GiIcon);
export default MemoGiIcon;
