...
interface CasesIconProps extends IconComponentProps { }

const CasesIcon: React.FC<CasesIconProps> = (props: CasesIconProps) => {
  const {
    fill,
    size = 20,
    iconClassName = "",
