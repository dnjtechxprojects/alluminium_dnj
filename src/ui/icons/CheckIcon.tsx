...
interface CheckIconProps extends IconComponentProps {}

const CheckIcon: React.FC<CheckIconProps> = (props: CheckIconProps) => {
  const {
    fill = "white",
    size = 20,
    iconClassName = "",
    ...
    <>
      ...
      >
        ...
        <path
          ...
          className={`${allPathClassName} ${pathClassName?.[4]}`}></path>
      </svg>
